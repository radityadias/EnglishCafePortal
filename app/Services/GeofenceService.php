...
class GeofenceService
{
    ...
    private static function calculateDelta(float $point1, float $point2)
    {
        return deg2rad($point2 - $point1);
    }

    private static function calculateChordLength(float $lat1, float $lon1, float $lat2, float $lon2, float $latDelta, float $lonDelta)
    {
        return
    ...
    private static function calculateAngularDistance(float $a)
    {
